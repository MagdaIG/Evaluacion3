...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EquipoIdBody', function() {
      beforeEach(function() {
        instance = new ApiDeEnergyAndWater.EquipoIdBody();
      });

      it('should create an instance of EquipoIdBody', function() {
        // TODO: update the code to test EquipoIdBody
        expect(instance).to.be.a(ApiDeEnergyAndWater.EquipoIdBody);
      });
