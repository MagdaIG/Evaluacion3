...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1HistoriaBody', function() {
      beforeEach(function() {
        instance = new ApiDeEnergyAndWater.V1HistoriaBody();
      });

      it('should create an instance of V1HistoriaBody', function() {
        // TODO: update the code to test V1HistoriaBody
        expect(instance).to.be.a(ApiDeEnergyAndWater.V1HistoriaBody);
      });
