...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CategoriaServicioIdBody1', function() {
      beforeEach(function() {
        instance = new ApiDeEnergyAndWater.CategoriaServicioIdBody1();
      });

      it('should create an instance of CategoriaServicioIdBody1', function() {
        // TODO: update the code to test CategoriaServicioIdBody1
        expect(instance).to.be.a(ApiDeEnergyAndWater.CategoriaServicioIdBody1);
      });
