...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InfoContactoIdBody1', function() {
      beforeEach(function() {
        instance = new ApiDeEnergyAndWater.InfoContactoIdBody1();
      });

      it('should create an instance of InfoContactoIdBody1', function() {
        // TODO: update the code to test InfoContactoIdBody1
        expect(instance).to.be.a(ApiDeEnergyAndWater.InfoContactoIdBody1);
      });
