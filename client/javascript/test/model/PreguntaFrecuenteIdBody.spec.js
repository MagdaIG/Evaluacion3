...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PreguntaFrecuenteIdBody', function() {
      beforeEach(function() {
        instance = new ApiDeEnergyAndWater.PreguntaFrecuenteIdBody();
      });

      it('should create an instance of PreguntaFrecuenteIdBody', function() {
        // TODO: update the code to test PreguntaFrecuenteIdBody
        expect(instance).to.be.a(ApiDeEnergyAndWater.PreguntaFrecuenteIdBody);
      });
