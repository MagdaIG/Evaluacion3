...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MantenimientoInfoIdBody1', function() {
      beforeEach(function() {
        instance = new ApiDeEnergyAndWater.MantenimientoInfoIdBody1();
      });

      it('should create an instance of MantenimientoInfoIdBody1', function() {
        // TODO: update the code to test MantenimientoInfoIdBody1
        expect(instance).to.be.a(ApiDeEnergyAndWater.MantenimientoInfoIdBody1);
      });
