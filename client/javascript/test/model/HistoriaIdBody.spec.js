...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HistoriaIdBody', function() {
      beforeEach(function() {
        instance = new ApiDeEnergyAndWater.HistoriaIdBody();
      });

      it('should create an instance of HistoriaIdBody', function() {
        // TODO: update the code to test HistoriaIdBody
        expect(instance).to.be.a(ApiDeEnergyAndWater.HistoriaIdBody);
      });
