...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1MantenimientoInfoBody', function() {
      beforeEach(function() {
        instance = new ApiDeEnergyAndWater.V1MantenimientoInfoBody();
      });

      it('should create an instance of V1MantenimientoInfoBody', function() {
        // TODO: update the code to test V1MantenimientoInfoBody
        expect(instance).to.be.a(ApiDeEnergyAndWater.V1MantenimientoInfoBody);
      });
