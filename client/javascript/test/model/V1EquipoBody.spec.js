...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1EquipoBody', function() {
      beforeEach(function() {
        instance = new ApiDeEnergyAndWater.V1EquipoBody();
      });

      it('should create an instance of V1EquipoBody', function() {
        // TODO: update the code to test V1EquipoBody
        expect(instance).to.be.a(ApiDeEnergyAndWater.V1EquipoBody);
      });
