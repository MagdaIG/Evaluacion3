...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1InfoContactoBody', function() {
      beforeEach(function() {
        instance = new ApiDeEnergyAndWater.V1InfoContactoBody();
      });

      it('should create an instance of V1InfoContactoBody', function() {
        // TODO: update the code to test V1InfoContactoBody
        expect(instance).to.be.a(ApiDeEnergyAndWater.V1InfoContactoBody);
      });
