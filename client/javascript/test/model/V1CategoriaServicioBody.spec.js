...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1CategoriaServicioBody', function() {
      beforeEach(function() {
        instance = new ApiDeEnergyAndWater.V1CategoriaServicioBody();
      });

      it('should create an instance of V1CategoriaServicioBody', function() {
        // TODO: update the code to test V1CategoriaServicioBody
        expect(instance).to.be.a(ApiDeEnergyAndWater.V1CategoriaServicioBody);
      });
